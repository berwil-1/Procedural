...
void RotateSprite( const uint idx, float angle );
void ScaleSprite( const uint idx, float scale );
...
void StampSpriteTo( const uint idx, const int3 pos );
void StampSpriteTo( const uint idx, const uint3 pos );
